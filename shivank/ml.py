...
cars_df = pd.read_excel("/Users/scaler/Documents/SeptMlops/SepStreamlit/shivank/cars24-car-price.xlsx")
...
def model_pred(fuel_type, transmission_type, engine, seats):
    ## loading the model
    with open("/Users/scaler/Documents/SeptMlops/SepStreamlit/shivank/car_pred", 'rb') as file:
